//------------------------------------------------------------------------------
// <copyright file="FileLinkCommand.cs" company="Company">
...
namespace WebResourceLinkerVsix
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class FileLinkCommand : WebResourceLinkerCommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        void OnBeforeQueryStatus(object sender, EventArgs e)
        {
            ...
            //    if (Path.GetExtension(fullPath).ToLowerInvariant() == ".tini")
            //    {
            //        item.Visible = true;
            //        return;
            //    }
        ...
        /// </summary>
        public static FileLinkCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new FileLinkCommand(package);
        }
